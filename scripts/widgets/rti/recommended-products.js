                ...
                */
                buildUrl = function() {
                    ...
                    var userIdQuery = "&userId=" + getCookie('bn_u'),
                        bnExtUserIdQuery = "&User.bnExtUserId=" + HyprLiveContext.locals.user.userId;
                    ...
                    if (getRTIOptions().includeTenantId) {
                        tenantIdQuery += "&tenantId=" + HyprLiveContext.locals.siteContext.tenantId;
                    }
                    if (getRTIOptions().includeSiteId) {
                        siteIdQuery += "&siteId=" + HyprLiveContext.locals.siteContext.siteId;
                    }
                ...
                */
                parseProducts = function(data) {
                    ...
                    if (dataList.length > 0) {
                        dataList.bnData = data.trackingData;
                    }
                    return dataList;
                };
