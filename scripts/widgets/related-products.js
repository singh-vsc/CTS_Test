            ...
            $('[data-mz-related-products]').each(function (index, rp) {
                ...
                var RelatedProductsView = Backbone.MozuView.extend({
                    ...
                    selectSwatchOption: function(e) {
                        ...
                        var imagepath = imagefilepath + '/' + productCode + '_' + colorCode + '.jpg?maxWidth=' + width + '&_mzcb=' +HyprLiveContext.locals.siteContext.generalSettings.cdnCacheBustKey;
                            ...
                            for (var i = 0; i < product.options.length; i++) {
                                if (product.options[i].attributeFQN == "tenant~COLOR") {
                                    for (var j = 0; j < product.options[i].values.length; j++) {
                                        ...
                                        var swatchIconPath = imagefilepath + '/' + product.productCode + '_' + color + '_sw.jpg?maxWidth=' + swatchIconSize + '&_mzcb=' +HyprLiveContext.locals.siteContext.generalSettings.cdnCacheBustKey;
