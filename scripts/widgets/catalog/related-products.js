require([
    ...
    var GenericProductSliderView = Backbone.MozuView.extend({
        ...
        initialize: function() {
            this.owl = null;
            var self = this;
            var isUserAnonymous = HyprLiveContext.locals.user.isAnonymous;
        ...
        addToWishlist: function(e) {
            ...
            var newPromise = api.createSync('wishlist').getOrCreate(HyprLiveContext.locals.user.accountId).then(function(wishlist) {
