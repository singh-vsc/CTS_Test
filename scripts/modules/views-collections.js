...
define([
...
], function(Backbone, $, _, HyprLiveContext, UrlDispatcher, IntentEmitter, getPartialView, colorSwatch, blockUiLoader, InfiniteScroller, generalFunctions,AdaFunctions) {
    ...
    function factory(conf) {
            ...
            if (path.indexOf("facetValueFilter") > -1) {
                ...
                if (facetValue !== "") {
                    ...
                    for (var j = 0; j < facetValue.length; j++) {
                        ...
                        if (facetKey === 'price') {
                            if (displayValue.indexOf("* TO") >= 0) {
                                displayValue = displayValue.replace("* TO ", "");
                                displayValue += " and under";
                            } else if (displayValue.indexOf("TO *") >= 0) {
                                displayValue = displayValue.replace(" TO *", "+");
                            } else if (displayValue.indexOf(" TO ") >= 0) {
                                displayValue = displayValue.replace(" TO ", " TO $");
                            }
        ...
        function updateUi(response) {
            ...
            $('html,body').scrollTop($('#products-wrapper').offset().top);
        ...
        IntentEmitter(
            ...
            _.throttle(onMouseEnterChangeImage,500)
        ...
        IntentEmitter(
            ...
            _.throttle(onMouseLeaveResetImage,500)
        );
