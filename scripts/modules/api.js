...
define(['sdk', 'jquery', 'hyprlive','hyprlivecontext'], function (Mozu, $, Hypr, hyprlivecontext) {
    ...
    if (Hypr.getThemeSetting('useDebugScripts') || hyprlivecontext.locals.pageContext.isDebugMode) {
