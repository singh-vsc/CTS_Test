define(
    ['modules/jquery-mozu', 'modules/backbone-mozu','hyprlive',"modules/models-product",'underscore','hyprlivecontext'],
    function($, Backbone, Hypr, ProductModels,_, HyprLiveContext) {
$(function(){
/* jshint ignore:start */
