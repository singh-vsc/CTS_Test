define([
    ...
    var sitecontext = HyprLiveContext.locals.siteContext,
        ...
        function getProductCodeFromUrl() {
            return HyprLiveContext.locals.pageContext.productCode||null;
        }
        ...
        function getCurrentProducts() {
            var products = [];
            for(var i=0;i<cookieValue.length;i++) {
                if(cookieValue[i].last + rviDuration > (new Date()).getTime() && cookieValue[i].pCode != HyprLiveContext.locals.pageContext.productCode) {
