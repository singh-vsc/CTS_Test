    ...
    function($, _, Hypr, Backbone, api, CustomerModels, AddressModels, PaymentMethods, HyprLiveContext) {
        ...
        var CheckoutPage = Backbone.MozuModel.extend({
            ...
            addCustomerContact: function(infoName, contactName, contactTypes) {
                ...
                // handle email
                if (!orderContact.email) orderContact.email = this.get('email') || this.get('emailAddress') || customer.get('emailAddress') || HyprLiveContext.locals.user.email;
            ...
            ensureEmailIsSet: function() {
                ...
                var billingEmail = this.get('billingInfo.billingContact.email'),
                    customerEmail = this.get('emailAddress') || HyprLiveContext.locals.user.email,
                    orderEmail = this.get('email');
            ...
            submit: function() {
                var order = this,
                    ...
                    isAuthenticated = HyprLiveContext.locals.user.isAuthenticated,
