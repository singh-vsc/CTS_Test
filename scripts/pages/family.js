define([
    ...
    var FamilyItemView = Backbone.MozuView.extend({
            ...
            api.get("cart").then(function(resp) {
                ...
                if (limitAttribute) {
                    ...
                    if (itemQuantity > limitperorder) {
                        $('#'+pdtCode).find("[data-mz-validationmessage-for='quantity']").text("*Max " + limitperorder + " item(s) are allowed.");
        ...
        changeImages: function(_e,colorCode, _updateThumbNails) {
            ...
            var mainImage = imagepath + '?maxWidth='+ width_fam + '&_mzcb=' +HyprLiveContext.locals.siteContext.generalSettings.cdnCacheBustKey;
