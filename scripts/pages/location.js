            ...
            LocationsView = Backbone.MozuView.extend({
                ...
                bindMarkers: function(location, marker) {
                    ...
                    DOM.on("click", function() {
                        $('html,body').scrollTop($('#mz-store-locator-map').offset().top);
                ...
                getGeoCode: function(zipCode, callback) {
                    ...
                    var settings = {
                      ...
                      "crossDomain": true,
                      "countrycodes": "us",
                      "url": "https://us1.locationiq.com/v1/search.php?key=pk.c3080a8c1f2c3da4a91193599163e094&q=" + zipCode + "&format=json",
                      "method": "GET"
                    };
                    ...
                    callback(response);
                    document.getElementById("success-shops").innerHTML = "Stores near " + response[0].display_name;
                    ...
                    //         console.log(results);
                    //         callback(results);
                    //         document.getElementById("success-shops").innerHTML = "Stores near " + results[0].display_name;
                    //         document.getElementsByClassName("invalid-location")[0].classList.add("hidden");
                    //         document.getElementById("noNearbyStores").classList.add("hidden");
                    //     } else {
        ...
        $(document).ready(function() {
            ...
            btnFindStores.on("click", function() {
                ...
                if(HyprLiveContext.locals.themeSettings.tealiumEnabled){
                    ...
                    var utagView = {
                        'event_name' : 'store locator search',
                        'store_search_term' : zipcode
                    };
